---
name: audit-worker
description: Arbeitet ein [suffix].audit.md ab. Aktivieren wenn ein Audit im Projekt-Ordner liegt, oder bei "arbeite das Audit ab", "fuehre das Audit aus", "Audit starten".
---
...
- Ein Orchestrator dispatcht einen Task
...
6. **Abschluss (Pflicht-Output am Ende JEDER Welle):**
   ...
   - Falls Reviewer-Welle vorgesehen: erst nach Reviewer-PASS externe Kommentare (Notion/Linear/etc.) schreiben.
